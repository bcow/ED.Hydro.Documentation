...
```{r, echo = FALSE}
kable(species_case %>% filter(case == 6)) %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"))
```
...
```{r, echo = FALSE}
kable(species_case %>% filter(case == 7)) %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"))
```
...
```{r, echo = FALSE}
kable(species_case %>% filter(case == 8)) %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"))
```

Also, looking specifically at the resuilt for BURSERA SIMAROUBA, I'm not confident in that result and I may double check it by hand. 
...
```{r, echo = FALSE}
kable(species_case %>% filter(case == 9)) %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"))
...
```{r, echo = FALSE}
kable(species_case %>% filter(case == 10)) %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"))
```
### None of the names are in BETY {-}
...
```{r, echo = FALSE}
kable(species_case %>% filter(case == 11)) %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"))
```
...
```{r, echo = FALSE}
kable(species_case %>% filter(case == 12)) %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"))
```
